...
**注意**: After Effectsのエフェクトはすべて未対応です。エフェクトを使用する場合は、事前にレンダリングして動画や画像シーケンスとして使用してください。

**書き出しツールの自動プリレンダリング機能**: `ExportComposition.jsx`書き出しツールは、エフェクトを検出すると自動的にプリコンポーズを作成し、PNG画像シーケンスとしてプリレンダリングします。この機能により、手動でのプリレンダリング作業が不要になります。
