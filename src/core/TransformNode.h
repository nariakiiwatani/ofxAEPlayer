...
public:
	...
	const ofVec3f& getTranslation() const { return translation_; }
	const ofQuaternion& getOrientation() const { return orientation_; }
	const ofVec3f& getScale() const { return scale_; }
	const ofVec3f& getAnchorPoint() const { return anchor_point_; }
	const ofVec3f& getRotation() const { return rotation_; }
